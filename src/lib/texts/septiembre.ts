// src/lib/texts/septiembre.ts
import type { DailyText } from '@/lib/texts';

// Este es un archivo de ejemplo. Puedes añadir aquí los textos para septiembre.
...
const dailyTexts: DailyText[] = [
  ...
  },
  {
    level: 'secundaria',
    day: 9,
    text: 'ORACIÓN\nDios de toda la vida, te damos gracias por el don de la tierra, nuestra casa común. En este momento, muchas personas, los océanos y los ecosistemas de la tierra están luchando por sobrevivir. Ayúdanos a cambiar nuestra forma de actuar y guíanos a vivir una vida que no se centre exclusivamente en nosotros mismos, sino en las necesidades de los demás y en el culto a ti como nuestra máxima preocupación. Escúchanos, Señor.\nOremos unos por otros en este momento para que podamos vivir la visión y los valores de la encíclica del Papa Francisco sobre el cuidado de nuestra casa común. En particular, pedimos que se preste mayor atención a la justicia social y la justicia climática. Escúchanos, Señor.\nSeñor, te pedimos que podamos apreciar más profundamente la la belleza y la diversidad de todo lo que has creado. Mientras recorremos nuestro curso, ayúdanos a escuchar también la voz de la creación, a reconocer lo profundamente interconectados que estamos entre nosotros y con el mundo natural. Escúchanos, Señor.\nSeñor, en el espíritu de la llamada de tu Hijo, Jesús, a seguirle, renunciando a nosotros mismos, que nos decidamos a frenar todas las acciones individuales egoístas que entran en conflicto con nuestra interrelación entre nosotros y con el mundo natural. Te pedimos que nos apartemos de los combustibles fósiles y elijamos nuevas opciones de inversión, como las energías renovables, y que compartamos mejor los dones de la creación. Escúchanos, Señor.'
  },
  {
    level: 'secundaria',
    day: 10,
  ...
  },
  {
    level: 'secundaria',
    day: 19,
    text: 'Plegaria para orar en común\nOh Dios creador, enséñanos a ver tus huellas en la belleza de la creación.\nAyúdanos a escuchar la voz de la creación, inspirarnos a respetar los derechos de todas las personas y de todas las especies vivas, a compartir tus dones hoy y a ser siempre conscientes de los que vienen después de nosotros.\nSeñor, escúchanos.\nInvitamos a hacer peticiones espontáneas por la Creación.'
  },
  {
    level: 'secundaria',
    day: 22,
  ...
  },
  {
    level: 'secundaria',
    day: 23,
    text: 'POR NUESTRA RELACIÓN CON TODA LA CREACIÓN\nSeñor, Tú amas todo lo que has creado, y nada existe fuera del misterio de Tu ternura.\nCada criatura, por pequeña que sea, es fruto de tu amor y tiene un lugar en este mundo.\nIncluso la vida más breve o sencilla es rodeada por tu cariño.\nComo san Francisco de Asís, hoy también queremos decir:\n“¡Alabado seas, mi Señor!”\nPorque a través de la belleza de la creación te dejas ver como fuente bondadosa, te pedimos:\nAbre nuestros ojos para reconocerte, aprendiendo del misterio de tu cercanía a todo lo creado, que el mundo es infinitamente más que un problema que resolver.\nEs un misterio que se contempla con gratitud y esperanza.\nAyúdanos a descubrir Tu presencia en todo lo creado, para que, enteramente reconociendo, podamos sentirnos y sabernos responsables por esta casa común donde nos invitas a cuidar, respetar y proteger la vida en todas sus formas y posibilidades.\n¡Alabado seas, Señor! Amén.'
  },
  {
    level: 'secundaria',
    day: 24,
  ...
  },
  {
    level: 'secundaria',
    day: 25,
    text: 'Canción-oración\nhttps://www.youtube.com/watch?v=kPXm5jyROs0'
  },
  {
    level: 'secundaria',
    day: 26,
  ...
  },
  {
    level: 'secundaria',
    day: 29,
    text: 'Reflexión:\nArmonía, serenidad, contemplación, paz, belleza, hermandad, solidaridad, autenticidad... Laudato si’—pobreza, desarrollo, población, recursos, medioambiente, sostenibilidad, migraciones…\nLa convicción de que en el mundo todo se interrelaciona y la íntima unión entre los pobres y la fragilidad del planeta. El clamor de la tierra va esencialmente unido al clamor de los pobres: no se puede escuchar uno y desoír el otro. La «ecología integral» reclama que las soluciones a los serios problemas medioambientales se unan a decisiones que mitiguen la marginación, la pobreza y la injusticia.\nEl daño social y el daño ambiental son caras de una misma moneda.\nLas agendas políticas, los organismos internacionales, las ONG, las instituciones y cada uno de nosotros debemos preocuparnos tanto por el cambio climático como por los refugiados que arriesgan su vida intentando llegar a sociedades donde vivir en paz.\nUrge rescatar la solidaridad como motor de nuestro actuar. Es preciso sentir que nos necesitamos los unos a los otros, que tenemos una responsabilidad hacia los demás y hacia el mundo.\nEl papa Francisco nos señalaba una de las claves para el cambio: disfrutar con poco, vivir con sobriedad y retornar a una simplicidad que nos permita valorar lo pequeño. Asimismo, apunta cuál es el mejor lugar para conseguirlo: la familia. Solo a través del amor incondicional que se vive en ella se puede aprender a incorporar en nuestra vida las dinámicas del don que transformen esta sociedad en una auténtica «casa común».'
  },
  {
    level: 'secundaria',
    day: 30,
