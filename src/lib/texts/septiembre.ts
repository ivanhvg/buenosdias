...
const dailyTexts: DailyText[] = [
  {
    ...
    level: 'primaria',
    day: 2,
    text: 'Nuestro planeta es un regalo increíble, lleno de animales, plantas, ríos y montañas. Pero a veces, sin darnos cuenta, lo ensuciamos y no lo cuidamos como se merece. Es como si tuviéramos una habitación preciosa y la dejáramos desordenada y sucia. \n\nHoy vamos a pensar en cómo podemos ser los guardianes de nuestra "casa común", la Tierra. Cada pequeño gesto cuenta: reciclar, no malgastar el agua, cuidar las plantas... Así, ayudamos a que nuestro hogar siga siendo un lugar maravilloso para todos.'
  },
  {
    level: 'secundaria',
    day: 3,
