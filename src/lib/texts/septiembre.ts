...
El lema de este curso dice: “SUEÑA PAZ Y SIEMBRA EL BIEN”
Momento de reflexión personal, piensa en los sueños de paz que te gustaría se hicieran realidad y que estas dispuesto/a a sembrar (realizar) para conseguirlos.`
  },
  {
    level: 'secundaria',
    day: 2,
...
¡Sois semillas de mi Reino! «Antes de formaros en el vientre de vuestra madre, yo os escogí.
...
Que al final del día, sienta la cercanía de tu presencia y la satisfacción de saber que en este día he hecho lo que a ti te agrada.`
  ...
  },
  {
    level: 'secundaria',
    day: 11,
    text: 'La sostenibilidad no es solo reciclar. Implica pensar en cómo nuestras acciones de hoy afectarán al mundo de mañana. ¿De qué manera tus hábitos de consumo impactan en el medio ambiente y qué podrías cambiar?'
  },
  {
    level: 'secundaria',
    day: 12,
    text: 'La solidaridad va más allá de dar lo que nos sobra. Significa empatizar con las luchas de otros y actuar. ¿Qué problema social te preocupa y cómo podrías involucrarte para generar un cambio positivo?'
  }
];
