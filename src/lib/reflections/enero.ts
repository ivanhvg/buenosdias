// src/lib/reflections/enero.ts
import type { DailyReflection } from '@/lib/reflections';

// Pistas para la reflexión del mes de enero.
const dailyReflections: DailyReflection[] = [
  {
    level: 'infantil-primaria',
    day: 12,
    questions: [
      'Busca un momento del día para hacer algo amable por alguien que esté triste o solo, como hizo la niña con el farol.',
      'Dibuja o imagina una luz dentro de ti. ¿Qué cualidad (bondad, alegría, paciencia) la enciende y cómo puedes compartirla hoy?',
      'Escribe o piensa una frase que te recuerde que la alegría no se apaga aunque terminen las fiestas.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 13,
    questions: [
      'Piensa en una persona que haya ayudado a otros y agradece su esfuerzo con una tarjeta, un dibujo o una palabra.',
      'Haz una pequeña acción de acogida: saluda con una sonrisa a alguien nuevo o invita a jugar a quien esté solo.',
      'Habla con tu familia sobre cómo pueden ayudar juntos a alguien que lo necesite este mes.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 15,
    questions: [
      'Dibuja un corazón y escribe dentro algo por lo que vas a rezar esta semana por tu familia.',
      'Pide a tus padres que te cuenten una historia bonita de cuando eras pequeño y agradece ese amor.',
      'Haz un pequeño gesto de cariño (un abrazo, una nota) a un familiar sin que te lo pidan.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 19,
    questions: [
      'Piensa en una situación difícil en clase o en casa. ¿Cómo puedes colaborar con otros para construir un “puente” y resolverlo?',
      'Escoge una cualidad tuya (como la paciencia, la fuerza o la visión) y úsala para ayudar a alguien hoy.',
      'Trabaja en equipo con un compañero para hacer una tarea sencilla y observa cómo juntos pueden lograr más.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 20,
    questions: [
      'Observa a tu alrededor: ¿quién es un “héroe” en tu vida por ayudar a otros (un maestro, un familiar, un vecino)?',
      'Haz una acción valiente hoy: ayuda a alguien sin que te lo pidan, como hizo Pedro.',
      'Escribe o dibuja cómo puedes ser un héroe sin capa en tu casa, en el colegio o en la calle.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 22,
    questions: [
      'Dibuja una bandera de Venezuela y escribe una oración sencilla por las personas que viven allí.',
      'Aprende una palabra en español que se use en Venezuela (como “chévere” o “pana”) y úsala con respeto hoy.',
      'Habla con tu familia sobre cómo pueden ayudar a otros países hermanos desde casa.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 26,
    questions: [
      'Si discutes con alguien hoy, en lugar de insistir en tener la razón, propón una solución que beneficie a los dos.',
      'Dibuja una flor y piensa en una situación difícil en la que podrías dejar un gesto de paz, como hizo el niño.',
      'Habla con un compañero o amigo sobre cómo pueden resolver un problema sin pelearse.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 27,
    questions: [
      'Escucha el villancico o el vídeo de la tregua y comenta con tu familia qué te llamó la atención de la historia.',
      'En lugar de competir o pelear por algo hoy, propón jugar o compartir con buena actitud.',
      'Escribe una carta o dibuja un mensaje de paz para alguien que esté triste o enojado.'
    ]
  },
  {
    level: 'secundaria',
  ...
  },
  {
    ...
    day: 29,
    questions: [
      'Enciende una vela en casa (o dibuja una) y haz un momento de silencio pidiendo por la paz en el mundo.',
      'Habla con tus compañeros sobre cómo pueden construir la paz en el aula (sin peleas, con respeto).',
      'Escribe una frase que te recuerde por qué la paz es importante para ti.'
    ]
  },
  {
    level: 'secundaria',
